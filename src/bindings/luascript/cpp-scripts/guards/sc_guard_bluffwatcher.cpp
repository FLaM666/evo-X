...
bool GossipHello_guard_bluffwatcher(Player *player, Creature *_Creature)
{
    ...
    player->ADD_GOSSIP_ITEM( 0, "The weapon master"     , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 7);
    player->ADD_GOSSIP_ITEM( 5, "The stable master"     , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 8);
    player->ADD_GOSSIP_ITEM( 8, "The battlemaster"      , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 9);
    player->ADD_GOSSIP_ITEM( 3, "A class trainer"       , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 10);
    player->ADD_GOSSIP_ITEM( 3, "A profession trainer"  , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 11);
