...
extern void AddSC_boss_cyanigosa();                        //violet_hold
...
extern void AddSC_boss_argent_challenge();                 //trial_of_the_champion
...
void AddScripts()
{
    ...
    AddSC_boss_cyanigosa();                                 //violet_hold
    AddSC_boss_erekem();
    AddSC_boss_ichoron();
    ...
    AddSC_boss_argent_challenge();                 //trial_of_the_champion
